...
This terraform module creates a federated identity credential for a user-assigned managed identity.
Used to exchange trusted access tokens from external identity providers for native Entra ID access tokens.
...
| Name | Type |
|------|------|
| [azurerm_federated_identity_credential.credential](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/federated_identity_credential) | resource |
